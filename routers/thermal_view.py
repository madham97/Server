...
<style>
  ...
  .pair img { width: 100%; height: 180px; object-fit: cover; border-radius: 4px; background: #000; display: block; }
  .pair p { margin: 4px 0 0; color: #888; font-size: 0.75em; text-align: center; }
  .missing { display: flex; align-items: center; justify-content: center; height: 180px; color: #f66; font-size: 0.8em; border: 1px dashed #444; border-radius: 4px; }
...
<body>
<h1>Thermal Pairs</h1>
<p class="sub">RGB / thermal captures split from RGBA uploads, newest first.</p>
"""
